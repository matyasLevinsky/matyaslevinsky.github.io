...
canonical-url: https://matyaslevinsky.github.io/posts/projects/SlerkaProjekt.html
...
categories: [project, author, data analysis]
execute:
  freeze: true
---
...
```{r}
#| fig-alt: "Stacked bar chart comparing sentiment emotion proportions across CNN articles on the Prague shooting and US mass shootings"
library(ggplot2)
library(scales)
...
```{r}
#| fig-alt: "Faceted bar charts showing top 10 terms per LDA topic across 12 CNN live-blog events"
...
```{r}
#| fig-alt: "Boxplots of gamma topic probability by CNN event, showing topic specificity of the Prague shooting"
